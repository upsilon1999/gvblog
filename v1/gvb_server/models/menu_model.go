...
type MenuModel struct {
	...
	TitleEn      string        `gorm:"size:32" json:"titleEn"`                                                                      // 英文标题
	Path         string        `gorm:"size:32" json:"path"`                                                                       // 路径
	Slogan       string        `gorm:"size:64" json:"slogan"`                                                                     // slogan
	Abstract     ctype.Array   `gorm:"type:string" json:"abstract"`                                                               // 菜单简介
	...
	BannerTime   int           `json:"bannerTime"`                                                                               // 菜单图片的切换时间 为 0 表示不切换
